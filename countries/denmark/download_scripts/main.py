...
try:
    logging.info("Attempting to import video_link_extractors from parent module...")
    from ..video_link_extractors import process_video_link
    logging.info("Successfully imported process_video_link from parent module")
except ImportError as e:
    logging.info(f"Import from parent module failed: {str(e)}")
    try:
        logging.info("Attempting to import video_link_extractors directly...")
        from video_link_extractors import process_video_link
        logging.info("Successfully imported process_video_link directly")
    except ImportError as e:
        logging.error(f"Failed to import process_video_link: {str(e)}")
        process_video_link = None
        logging.warning("Video link extractor set to None - video extraction will fail")
