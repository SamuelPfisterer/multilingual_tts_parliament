...
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/sweden/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/sweden/logs/%j.err
#SBATCH --mem=8G
#SBATCH --nodes=1
#SBATCH --cpus-per-task=2
#SBATCH --array=0-4  # 5 jobs total
...
TOTAL_FILES=6528  # Total number of sessions (minus header)
FILES_PER_JOB=1306  # Dividing total files into 5 jobs
