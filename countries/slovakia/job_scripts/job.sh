...
#SBATCH --job-name=slovakia_download
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/slovakia/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/slovakia/logs/%j.err
#SBATCH --mem=8G
#SBATCH --nodes=1
#SBATCH --cpus-per-task=2
#SBATCH --array=0-4  # 5 jobs to handle 1,277 sessions

ETH_USERNAME=spfisterer
PROJECT_NAME=Downloading/countries/slovakia
...
TOTAL_FILES=1277  # Total number of sessions
FILES_PER_JOB=256  # About 256 files per job
