...
#SBATCH --job-name=montenegro_download
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/montenegro/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/montenegro/logs/%j.err
#SBATCH --mem=8G
#SBATCH --nodes=1
#SBATCH --cpus-per-task=2
#SBATCH --array=0-3  # 4 jobs to handle ~320 sessions

ETH_USERNAME=spfisterer
PROJECT_NAME=Downloading/countries/montenegro
...
TOTAL_FILES=320  # Total number of sessions
FILES_PER_JOB=80  # 80 files per job for 4 jobs total
