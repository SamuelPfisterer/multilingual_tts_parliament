...
#SBATCH --job-name=hungary_download
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/hungary/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/hungary/logs/%j.err
#SBATCH --mem=8G
#SBATCH --nodes=1
...
PROJECT_NAME=Downloading/countries/hungary
...
TOTAL_FILES=1236  # Actual number of sessions in the CSV
FILES_PER_JOB=248  # 1236 / 5 = ~248 files per job
