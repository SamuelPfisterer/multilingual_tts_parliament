...
def main():
    ...
    base_dir = "/itet-stor/spfisterer/net_scratch/Downloading/countries/germany"
    csv_path = f"{base_dir}/links/germany_links.csv"
    ...
    aligner = AlignmentPipeline(
        ...
        transcript_dirs = ["downloaded_subtitle"]
    )
    
    # Process the subset
    aligner.process_subset(["7505029"])
