...
def main():
    ...
    base_dir = "/itet-stor/spfisterer/net_scratch/Downloading/countries/ukraine"
    csv_path = f"{base_dir}/links/ukraine_links_final.csv"
    ...
    aligner = AlignmentPipeline(
        ...
        transcript_dirs=["downloaded_transcript/ukraine_IX_convocation", "downloaded_transcript/ukraine_VIII_convocation"]
    )
    
    # Process the subset
    aligner.process_subset(["20170119_PL_2"])
