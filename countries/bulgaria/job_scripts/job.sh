...
#SBATCH --job-name=bulgaria_download
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/bulgaria/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/bulgaria/logs/%j.err
#SBATCH --mem=8G
#SBATCH --nodes=1
...
PROJECT_NAME=Downloading/countries/bulgaria
...
TOTAL_FILES=2549  # Replace with your actual number of sessions in bulgaria_links.csv
FILES_PER_JOB=510  # Adjust based on TOTAL_FILES and desired number of jobs
