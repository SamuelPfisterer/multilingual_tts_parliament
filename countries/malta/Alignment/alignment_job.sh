#!/bin/bash
#SBATCH --job-name=align_malta
#SBATCH --mail-type=ALL
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/malta/Alignment/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/malta/Alignment/logs/%j.err
#SBATCH --mem=20G
#SBATCH --nodes=1
...
PROJECT_DIR=/itet-stor/${ETH_USERNAME}/net_scratch/Downloading/countries/malta
