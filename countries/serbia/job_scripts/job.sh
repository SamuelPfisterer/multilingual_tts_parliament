...
#SBATCH --job-name=serbia_download
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/serbia/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/serbia/logs/%j.err
#SBATCH --mem=8G
#SBATCH --nodes=1
#SBATCH --cpus-per-task=2
#SBATCH --array=0-4  # 5 jobs to process 2833 files

ETH_USERNAME=spfisterer
PROJECT_NAME=Downloading/countries/serbia
...
TOTAL_FILES=2833  # Total number of sessions in CSV
FILES_PER_JOB=567  # ~567 files per job for 5 jobs
