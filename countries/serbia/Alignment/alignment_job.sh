...
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/serbia/Alignment/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/serbia/Alignment/logs/%j.err
#SBATCH --mem=20G
#SBATCH --nodes=1
#SBATCH --cpus-per-task=4
#SBATCH --gres=gpu:1
#SBATCH --nodelist=tikgpu[03,04,05,06],lbbgpu01,artongpu[01,02,03,04,05,06,07]
#SBATCH --array=0-3  # 4 jobs across the GPUs

ETH_USERNAME=spfisterer
PROJECT_DIR=/itet-stor/${ETH_USERNAME}/net_scratch/Downloading/countries/serbia
