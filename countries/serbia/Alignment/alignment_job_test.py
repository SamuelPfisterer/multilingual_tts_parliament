...
def main():
    ...
    base_dir = "/itet-stor/spfisterer/net_scratch/Downloading/countries/serbia"
    csv_path = f"{base_dir}/links/serbia_links.csv"
    ...
    # Process the subset
    aligner.process_subset(["serbia_2012_14_10122013"])
