#!/bin/bash
#SBATCH --job-name=align_lt
#SBATCH --mail-type=ALL
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/lithuania/Alignment/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/lithuania/Alignment/logs/%j.err
#SBATCH --mem=20G
#SBATCH --nodes=1
#SBATCH --cpus-per-task=4
#SBATCH --gres=gpu:1
#SBATCH --nodelist=tikgpu[02,03,04,05],lbbgpu01,artongpu[01,06,07]
#SBATCH --array=0-8  # 9 jobs across the GPUs

ETH_USERNAME=spfisterer
PROJECT_DIR=/itet-stor/${ETH_USERNAME}/net_scratch/Downloading/countries/lithuania
