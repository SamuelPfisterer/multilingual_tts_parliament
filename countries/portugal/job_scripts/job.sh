...
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/portugal/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/portugal/logs/%j.err
#SBATCH --mem=8G
#SBATCH --nodes=1
#SBATCH --cpus-per-task=2
#SBATCH --array=0-3  # 4 jobs to handle ~500 sessions each

ETH_USERNAME=spfisterer
PROJECT_NAME=Downloading/countries/portugal
...
TOTAL_FILES=1993  # Total number of sessions (excluding header)
FILES_PER_JOB=500  # Process ~500 files per job
