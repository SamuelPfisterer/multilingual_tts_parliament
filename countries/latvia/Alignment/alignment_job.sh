#!/bin/bash
#SBATCH --job-name=align_lv
#SBATCH --mail-type=ALL
#SBATCH --output=/itet-stor/spfisterer/net_scratch/Downloading/countries/latvia/Alignment/logs/%j.out
#SBATCH --error=/itet-stor/spfisterer/net_scratch/Downloading/countries/latvia/Alignment/logs/%j.err
#SBATCH --mem=20G
#SBATCH --nodes=1
